...
> Note that the example is in C because the gradual verifier I work in is implemented on  <a href="https://c0.cs.cmu.edu/docs/c0-libraries.pdf" style="color: #364491; border-bottom:1px dotted">C0</a>, apologies in advance.

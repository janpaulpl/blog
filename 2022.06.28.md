...
accessed by a computation, to read that memory region for example. Thereafter, its assured that the access to the rest of allocated memory is independent of this reading. This entire memory *chunk* is a frame.
